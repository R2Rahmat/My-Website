...
const ContactCTA = () => {
  return (
    <section className="py-20 bg-gradient-to-r from-portfolio-dark to-portfolio-card relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-portfolio-light/90 mb-8 max-w-2xl mx-auto">
