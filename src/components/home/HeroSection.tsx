...
const HeroSection = () => {
  return (
    <section className="relative py-20 md:py-32 bg-gradient-to-b from-portfolio-blue/20 to-portfolio-dark overflow-hidden">
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-portfolio-light animate-fade-in">
            Building <span className="text-portfolio-blue">digital products</span>, brands, and experiences
          </h1>
          <p className="text-xl text-portfolio-light/90 mb-8 md:text-2xl animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <Button asChild variant="outline" size="lg" className="rounded-full group border-portfolio-blue/50 text-portfolio-light hover:border-portfolio-blue hover:bg-portfolio-blue/10">
