...
const FeaturedProjects = () => {
  return (
    <section className="py-20 bg-portfolio-card/50">
      <div className="container mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div key={project.id} className="glass-card rounded-xl overflow-hidden group hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.slice(0, 3).map((tag) => (
                    <Badge key={tag} variant="secondary" className="bg-portfolio-dark/50 text-portfolio-light border border-portfolio-blue/20">
                      {tag}
                    </Badge>
                  ))}
                  {project.tags.length > 3 && (
                    <Badge variant="outline" className="text-portfolio-light border-portfolio-light/30">
                      +{project.tags.length - 3}
                    </Badge>
                  )}
                </div>
        ...
        <div className="mt-12 text-center">
          <Button asChild variant="outline" className="group border-portfolio-blue text-portfolio-blue hover:text-portfolio-light hover:bg-portfolio-blue">
